...
app.get("/api/movies/discover", async (req, res) => {
  ...
  try {
    ...
    url.searchParams.append("sort_by", sort_by || "popularity.desc");
    url.searchParams.append("include_adult", "false");
    url.searchParams.append("page", "1");

    if (with_genres) url.searchParams.append("with_genres", with_genres);
    if (without_genres) url.searchParams.append("without_genres", without_genres);
